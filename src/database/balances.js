...
async function CreateVesting ( owner, amount, dateStart, dateEnd) {
    let CreateQuery = `INSERT INTO vestings (address, value_total, value_paid, date_start, date_watched, date_end) VALUES ('${owner}', ${amount}, 0, ${dateStart}, ${dateStart}, ${dateEnd});`
